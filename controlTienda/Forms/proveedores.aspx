<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="proveedores.aspx.cs" Inherits="controlTienda.Forms.proveedores" %>
...
<body class="body-expanded">
    ...
    <div id="main-container">
        ...
        <div class="row">
            ...
            <div id="proveedores" class="col-md-6">
                <div id="table">
                    <div class="text-right">
                        <h3>
                            <label class="label label-success">PROVEEDORES</label>
    ...
    <div id="modal-proveedores" class="container-fluid">
        <header class="header">
            <label class="col-form-label">NUEVO PROVEEDOR</label>
        </header>
        <form id="formDatos">
            ...
            <div class="form-group">
                ...
                <input id="txttelefono" class="no-simbolos-especiales form-control campo-editable" type="text" />

            </div>
            <div class="form-group">
                <label class="col-form-label">Correo</label>
                <input id="txtcorreo" class="no-simbolos-especiales form-control campo-editable" type="text" />
